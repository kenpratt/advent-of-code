...
impl Game {
    ...
    const AFTER_ONE_ROUND: [usize; 22] = [
    ...
    fn play(parameters: &Parameters) -> usize {
        ...
        for round in 2..=game.num_rounds {
            let player_id = (round - 1) % parameters.num_players;
    ...
    fn after_one_round(parameters: &Parameters) -> Self {
        ...
        let num_marbles = num_rounds * 21 + 1;
        ...
        let mut scores = vec![0; parameters.num_players];
    ...
    fn place_subsequent_round(&mut self, round: usize, player_id: usize) {
        ...
        for i in 0..18 {
            let new_marble = first_new_marble + i;
        ...
        for i in 0..4 {
            let new_marble = first_new_marble + i + 18;
